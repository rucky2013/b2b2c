...
public class AlipaySubmit {
	...
	public static String buildForm(AlipayConfig config, Map<String, String> sParaTemp, String gateway, String strMethod,
	 ...
	 * @return 提交表单HTML文本
	 */
	public static String buildRequestWap(AlipayConfig config, Map<String, String> sParaTemp, String strMethod,
			String strButtonName) {
		// 待请求参数数组
	...
	public static String query_timestamp(AlipayConfig config) throws Exception {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + config.getPartner()
				+ "&_input_charset" + config.getInput_charset();
