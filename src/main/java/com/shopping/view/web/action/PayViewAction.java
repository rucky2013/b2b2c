...
public class PayViewAction {
	...
	public ModelAndView wxpaySuccess(HttpServletRequest request, HttpServletResponse response, String totalPrice) {
		ModelAndView mv = new JModelAndView("paysuccess.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 1, request, response);
	...
	public void alipayRetrun(HttpServletRequest request, HttpServletResponse respons) {
		...
		config.setReturn_url(
				CommUtil.getURL(request, this.configService.getSysConfig()) + "/alipay/aplipay_return.htm");
			...
			if (trade_status.equals("TRADE_FINISHED") || trade_status.equals("TRADE_SUCCESS")) {
				...
				try {
					respons.sendRedirect(
							CommUtil.getURL(request, this.configService.getSysConfig()) + "/alipay/paysuccess.htm");
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
