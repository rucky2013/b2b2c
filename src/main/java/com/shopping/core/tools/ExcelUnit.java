...
public class ExcelUnit {
	public static void exportExcel(String title, String[] headers, Collection<T> dataset, OutputStream out,
		 ...
		 * style_.setFillForegroundColor(43); style_.setFillPattern(1);
		 * style_.setBorderBottom(1); style_.setBorderLeft(1);
		 * style_.setBorderRight(1); style_.setBorderTop(1);
		 * 
		 * style_.setAlignment(2); style_.setVerticalAlignment(1);
		 * 
		 * HSSFFont font_ = workbook.createFont();
		 * 
		 * font.setBoldweight(400); style_.setFont(font_);
		 */
