...
public class IntegralGoodsManageAction {
	...
	public ModelAndView integral_goods(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String ig_goods_name, String ig_show) {
		ModelAndView mv = new JModelAndView("admin/blue/integral_goods.html", this.configService.getSysConfig(),
		...
		if (this.configService.getSysConfig().isIntegralStore()) {
			...
			if (!CommUtil.null2String(ig_show).equals("")) {
				qo.addQuery("obj.ig_show", new SysMap("ig_show", Boolean.valueOf(CommUtil.null2Boolean(ig_show))), "=");
			}
	...
	public ModelAndView integral_goods_add(HttpServletRequest request, HttpServletResponse response,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/integral_goods_add.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isIntegralStore()) {
	...
	public ModelAndView integral_goods_edit(HttpServletRequest request, HttpServletResponse response, String id,
		...
		if (this.configService.getSysConfig().isIntegralStore()) {
			if ((id != null) && (!id.equals(""))) {
				IntegralGoods integralgoods = this.integralgoodsService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public ModelAndView integral_goods_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String begin_hour, String end_hour, String list_url, String add_url) {
		...
		if (this.configService.getSysConfig().isIntegralStore()) {
			...
			if (id.equals("")) {
				...
				IntegralGoods obj = this.integralgoodsService.getObjById(Long.valueOf(Long.parseLong(id)));
			...
			String ext = goods.getIg_goods_img().getExt().indexOf(".") < 0 ? "." + goods.getIg_goods_img().getExt()
					: goods.getIg_goods_img().getExt();
			String source = request.getSession().getServletContext().getRealPath("/")
					+ goods.getIg_goods_img().getPath() + File.separator + goods.getIg_goods_img().getName();
	...
	public ModelAndView integral_order(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String igo_order_sn, String userName, String igo_payment,
			String igo_status) {
		ModelAndView mv = new JModelAndView("admin/blue/integral_order.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isIntegralStore()) {
			...
			if (!CommUtil.null2String(igo_status).equals("")) {
				qo.addQuery("obj.igo_status", new SysMap("igo_status", Integer.valueOf(CommUtil.null2Int(igo_status))),
						"=");
			}
	...
	public ModelAndView integral_order_view(HttpServletRequest request, HttpServletResponse response,
		...
		ModelAndView mv = new JModelAndView("admin/blue/integral_order_view.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isIntegralStore()) {
	...
	public ModelAndView integral_order_fee(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/integral_order_fee.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		IntegralGoodsOrder obj = this.integralGoodsOrderService.getObjById(CommUtil.null2Long(id));
		if (this.configService.getSysConfig().isIntegralStore()) {
			mv.addObject("obj", obj);
	...
	public ModelAndView integral_order_ship(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/integral_order_ship.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		IntegralGoodsOrder obj = this.integralGoodsOrderService.getObjById(CommUtil.null2Long(id));
		if (this.configService.getSysConfig().isIntegralStore()) {
			mv.addObject("obj", obj);
	...
	public String integral_order_ship_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String igo_ship_code, String igo_ship_time, String igo_ship_content) {
		IntegralGoodsOrder obj = this.integralGoodsOrderService.getObjById(CommUtil.null2Long(id));
		if (this.configService.getSysConfig().isIntegralStore()) {
