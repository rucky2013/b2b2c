...
public class AreaManageAction {
	...
	public ModelAndView area_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String pid, String orderBy, String orderType) {
		ModelAndView mv = new JModelAndView("admin/blue/area_setting.html", this.configService.getSysConfig(),
	...
	public ModelAndView area_save(HttpServletRequest request, HttpServletResponse response, String areaId, String pid,
	...
	public String area_del(HttpServletRequest request, String mulitId, String currentPage, String pid) {
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				params.put("ids", list);
				List<Area> objs = this.areaService.query("select obj from Area obj where obj.id in (:ids)", params, -1,
						-1);
				for (Area obj : objs) {
					obj.setParent(null);
	...
	public ModelAndView area_import(HttpServletRequest request, HttpServletResponse response, String list_url)
			throws Exception {
	...
	public ModelAndView area_export(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView mv = null;
		String path = request.getSession().getServletContext().getRealPath("/") + "resources" + File.separator + "data"
				+ File.separator + "base.sql";
	...
	public void area_ajax(HttpServletRequest request, HttpServletResponse response, String id, String fieldName,
