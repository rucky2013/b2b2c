...
public class SpareGoodsFloorManageAction {
	...
	public ModelAndView floor_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType) {
		ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_list.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsFloorQueryObject qo = new SpareGoodsFloorQueryObject(currentPage, mv, orderBy, orderType);
	...
	public ModelAndView floor_add(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_add.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		List sgcs = this.sparegoodsclassService.query("select obj from SpareGoodsClass obj where obj.parent.id is null",
				null, -1, -1);
		Map params = new HashMap();
		params.put("width", Integer.valueOf(200));
		params.put("height", Integer.valueOf(240));
		params.put("ap_type", "img");
		List advertposition = this.advertPositionService.query(
	...
	public ModelAndView floor_edit(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_add.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if ((id != null) && (!id.equals(""))) {
			SpareGoodsFloor sparegoodsfloor = this.sparegoodsfloorService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public ModelAndView floor_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String cmd, String list_url, String add_url, String cid, String advert_url,
			String ap_id, String advert_type) {
		...
		if (id.equals("")) {
			...
			SpareGoodsFloor obj = this.sparegoodsfloorService.getObjById(Long.valueOf(Long.parseLong(id)));
		...
		if ((ap_id != null) && (!ap_id.equals(""))) {
			AdvertPosition adp = this.advertPositionService.getObjById(CommUtil.null2Long(ap_id));
		...
		try {
			map = CommUtil.saveFileToServer(request, "advert_img", saveFilePathName, fileName, null);
	...
	public void floor_ajax(HttpServletRequest request, HttpServletResponse response, String id, String fieldName,
	...
	public String floor_delete(HttpServletRequest request, HttpServletResponse response, String mulitId,
			String currentPage) {
	...
	public ModelAndView floor_setclass(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String fid) {
		ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_setclass.html",
				this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsClassQueryObject qo = new SpareGoodsClassQueryObject(currentPage, mv, orderBy, orderType);
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil.null2Long(fid));
	...
	public void floor_class_ajax(HttpServletRequest request, HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
		SpareGoodsClass obj = this.sparegoodsclassService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public String floor_setclass_switch(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String fid, String mulitId, String type) {
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if ((id != null) && (!id.equals(""))) {
				SpareGoodsClass sgc = this.sparegoodsclassService.getObjById(CommUtil.null2Long(id));
		...
		return "redirect:sparegoodsfloor_setclass.htm?currentPage=" + currentPage + "&fid=" + fid;
	}
	...
	public ModelAndView floor_setgoods(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String fid) {
		ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_setgoods.html",
				this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil.null2Long(fid));
		Set ids = getSpareGoodsClassChildIds(sgf.getSgc());
		Map map = new HashMap();
		...
		map.clear();
		map.put("ids", ids);
		List<SpareGoods> sgs = this.sparegoodsService.query(
				"select obj from SpareGoods obj where obj.sgf.id is null and  obj.spareGoodsClass.id in (:ids)", map,
				-1, -1);
	...
	public String floor_setgoods_switch(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String mulitId, String fid, String type) {
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if ((id != null) && (!id.equals(""))) {
				SpareGoods sg = this.sparegoodsService.getObjById(CommUtil.null2Long(id));
				if ((type != null) && (!type.equals(""))) {
					if (type.equals("show"))
		...
		return "redirect:sparegoodsfloor_setgoods.htm?currentPage=" + currentPage + "&fid=" + fid;
	}
