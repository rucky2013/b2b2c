...
public class GoldRecordManageAction {
	...
	public ModelAndView gold_record(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String beginTime, String endTime, String beginCount, String endCount) {
		ModelAndView mv = new JModelAndView("admin/blue/gold_record.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isGold()) {
			GoldRecordQueryObject qo = new GoldRecordQueryObject(currentPage, mv, orderBy, orderType);
			...
			if (!CommUtil.null2String(beginCount).equals("")) {
				qo.addQuery("obj.gold_count", new SysMap("gold_count", Integer.valueOf(CommUtil.null2Int(beginCount))),
						">=");
			}
			if (!CommUtil.null2String(endCount).equals("")) {
				qo.addQuery("obj.gold_count", new SysMap("endCount", Integer.valueOf(CommUtil.null2Int(endCount))),
						"<=");
			}
	...
	public ModelAndView gold_log(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String beginTime, String endTime) {
		ModelAndView mv = new JModelAndView("admin/blue/gold_log.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isGold()) {
			GoldLogQueryObject qo = new GoldLogQueryObject(currentPage, mv, orderBy, orderType);
			if (!CommUtil.null2String(beginTime).equals("")) {
				qo.addQuery("obj.addTime", new SysMap("beginTime", CommUtil.formatDate(beginTime)), ">=");
			}
			if (!CommUtil.null2String(endTime).equals("")) {
	...
	public ModelAndView gold_record_edit(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/gold_record_edit.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isGold()) {
			if ((id != null) && (!id.equals(""))) {
				GoldRecord goldrecord = this.goldrecordService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public ModelAndView gold_record_save(HttpServletRequest request, HttpServletResponse response, String id,
		...
		if (this.configService.getSysConfig().isGold()) {
			...
			if (id.equals("")) {
				...
				GoldRecord obj = this.goldrecordService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public String gold_record_del(HttpServletRequest request, HttpServletResponse response, String mulitId,
			String currentPage) {
		if (this.configService.getSysConfig().isGold()) {
	...
	public ModelAndView gold_record_view(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/gold_record_view.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (this.configService.getSysConfig().isGold()) {
			if ((id != null) && (!id.equals(""))) {
				GoldRecord goldrecord = this.goldrecordService.getObjById(Long.valueOf(Long.parseLong(id)));
