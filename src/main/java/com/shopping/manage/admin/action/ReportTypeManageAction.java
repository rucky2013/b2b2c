...
public class ReportTypeManageAction {
	...
	public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage,
		...
		ModelAndView mv = new JModelAndView("admin/blue/reporttype_list.html", this.configService.getSysConfig(),
		...
		String params = "";
		ReportTypeQueryObject qo = new ReportTypeQueryObject(currentPage, mv, orderBy, orderType);
		WebForm wf = new WebForm();
		wf.toQueryPo(request, qo, ReportType.class, mv);
		IPageList pList = this.reporttypeService.list(qo);
		CommUtil.saveIPageList2ModelAndView(url + "/admin/reporttype_list.htm", "", params, pList, mv);
		return mv;
	}
	...
	public ModelAndView add(HttpServletRequest request, HttpServletResponse response, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/reporttype_add.html", this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
		...
		if ((id != null) && (!id.equals(""))) {
			ReportType reporttype = this.reporttypeService.getObjById(Long.valueOf(Long.parseLong(id)));
	...
	public ModelAndView save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage,
		...
		if (id.equals("")) {
			...
			ReportType obj = this.reporttypeService.getObjById(Long.valueOf(Long.parseLong(id)));
